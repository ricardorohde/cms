<?php
    ...
    class Contato extends MY_Controller
    {
        ...
        function index()
        {
            $this->load->view('paginas/contato');
        }
        //**********************************************************************
        ...
        function buscar_contatos($offset = 0)
        {
            ...
            $config['base_url']     = app_baseUrl() . 'contato/buscar_contatos';
            ...
            $this->load->view('paginas/paginados/contato_paginado', $this->dados);
        }
        //**********************************************************************
        ...
        function verificar_mensagem()
        {
            ...
            $this->load->view('paginas/mensagens/abrir_email', $this->dados);
        }
        //**********************************************************************
        ...
        function responder_mensagem()
        {
            $id = $this->uri->segment(3);
            $this->dados['mensagem'] = $this->busca_mensagem($id);
            $this->load->view('paginas/mensagens/responder_email', $this->dados);
        }
        //**********************************************************************
