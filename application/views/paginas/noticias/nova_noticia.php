    ...
    $("#configuracao_noticia").submit(function(e) {
        ...
        $.ajax({
            ...
            success: function(sucesso)
            {
                if (sucesso.erro_salvamento !== "" && sucesso.erro_salvamento === 0)
                {
                    $.smallBox({
                        ...
                        content: "<strong>Não foi possível salvar a notícia</strong>",
                        color: "#FE1A00",
                ...
                {
                    url = "index.php?/noticias_cadastradas";
                    loadURL(url, $("#content"));
                }
                else if (sucesso.erro_imagem !== "" && sucesso.erro_imagem === 2)
                {
                    $.smallBox({
                        title: "<i class='glyphicon glyphicon-remove'></i> Erro",
                        content: "<strong>Não foi possível redimensionar a imagem. Verifique o tipo e o caminho da imagem</strong>",
                        color: "#FE1A00",
                        iconSmall: "fa fa-thumbs-down bounce animated",
                        timeout: 5000
                    });
            ...
            error: function()
            {
                $.smallBox({
                    title: "<i class='glyphicon glyphicon-remove'></i> Erro",
                    content: "<strong>Não foi possível realizar a operação. Tente novamente</strong>",
                    color: "#FE1A00",
                    iconSmall: "fa fa-thumbs-down bounce animated",
                    timeout: 5000
                });
